	...
	import java.util.regex.*;
	    ...
	    public class passwordHelper {
	        ...
	        public static void main(String[] args) {
	            ...
	            do {
	                pInput = JOptionPane.showInputDialog(null, "Please enter your password.\n"
	                        + "Your password must have 8-128 characters\n"
	        ...
	        //public class passwordGeneratorClass {
	            ...
	            final class passwordGeneratorClass {
	                ...
	                private passwordGeneratorClass() {
	                    throw new UnsupportedOperationException("Empty constructor is not supported.");
	                }

	                private passwordGeneratorClass(PasswordGeneratorBuilder builder) {
	                ...
	                class PasswordGeneratorBuilder {
	                     ...
	                     * object.
	                     */
	                    public passwordGeneratorClass build() {
	                        return new passwordGeneratorClass(this);
	                    }
	                }
